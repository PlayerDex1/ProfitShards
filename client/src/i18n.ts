...
const dicts: Record<Lang, Dict> = {
  pt: {
    ...
    'calc.useMap': 'Calcular pelo mapa',
    'calc.map': 'Mapa',
    'calc.mapEfficiency': 'Eficiência do jogador',
    'calc.estimatedTokens': 'Tokens estimados',
    'map.forest': 'Floresta',
    'map.desert': 'Deserto',
    'map.tundra': 'Tundra',
  ...
  en: {
    ...
    'calc.useMap': 'Use map calculation',
    'calc.map': 'Map',
    'calc.mapEfficiency': 'Player efficiency',
    'calc.estimatedTokens': 'Estimated tokens',
    'map.forest': 'Forest',
    'map.desert': 'Desert',
    'map.tundra': 'Tundra',
