...
const dicts: Record<Lang, Dict> = {
  pt: {
    ...
    'results.equipTokens': 'Tokens gastos em aceleração',
    ...
    'results.netTokens': 'Tokens Líquidos',
    ...
    'home.hero.cta.register': 'Criar Conta Grátis',
    'home.features.title': 'Suas Ferramentas de Sucesso',
    'home.features.subtitle': 'Tudo que você precisa para dominar o WorldShards em um só lugar',
    'home.features.calculator.badge1': 'ROI em tempo real',
    'home.features.calculator.badge2': 'Simulação avançada',
    'home.features.map.title': 'Planejador de Mapas',
    'home.features.map.description': 'Registre suas runs, analise eficiência e contribua para as estatísticas da comunidade.',
    'home.features.map.badge1': 'Histórico completo',
    'home.features.map.badge2': 'Métricas detalhadas',
    'home.features.analytics.badge1': 'Gráficos dinâmicos',
    'home.features.analytics.badge2': 'Comparações',
    ...
    'home.loginButton': '🔐 Fazer Login',
    'home.loginRequired': '🔐 Login Necessário',
    'home.wantToAppear': '🚀 Quer aparecer aqui também?',
    'home.loginToAppear': 'Faça login e comece a usar as ferramentas para aparecer no feed da comunidade!',
    'home.communityComparison': 'Comparação com estatísticas da comunidade',
    
    // Features Section
    'home.features.calculator.title': '🧮 Calculadora de Lucro WorldShards',
    'home.features.calculator.description': 'Calcule seu lucro real com base em gemas, tokens e equipamentos. Analise custos de investimento, tokens farmados e retorno sobre cargas usadas para maximizar seus ganhos.',
    'home.features.calculator.benefit1': 'Cálculo preciso de gemas compradas vs. consumidas',
    'home.features.calculator.benefit2': 'Análise de tokens em equipamentos vs. farmados',
    'home.features.calculator.benefit3': 'Controle de cargas usadas e eficiência',
    'home.features.calculator.useButton': 'Usar Calculadora',
    
    'home.features.planner.title': '🗺️ Planejador de Mapas com Luck',
    'home.features.planner.description': 'Planeje suas estratégias de mapa baseado no seu luck total. Analise diferentes tamanhos de mapa (small, medium, large, xlarge) e otimize seus drops de tokens para máxima eficiência.',
    'home.features.planner.benefit1': 'Análise de mapas por tamanho e luck',
    'home.features.planner.benefit2': 'Controle de cargas e tokens dropados',
    'home.features.planner.benefit3': 'Histórico de eficiência por mapa',
    
    'home.features.analytics.title': '📊 Dashboard de Performance Completo',
    ...
    'metrics.todayTitle': 'Métricas (hoje desde 05:00)',
    'metrics.avgPerRunToday': 'Média de tokens por carga (hoje)',
    'metrics.totals': 'Totais',
    'metrics.todayFromTime': 'Hoje (desde 05:00)',
    'metrics.yesterdayRange': 'Ontem (05:00 → 05:00)',
    'metrics.bestHourToday': 'Melhor horário (hoje)',
    ...
    'profile.welcome': 'Olá, {name}! 👋',
    'profile.subtitle': 'Configurações e histórico sincronizados automaticamente',
    'profile.subtitleLocal': 'Dados salvos localmente no navegador',
    'profile.of': 'Perfil de {name}',
    'profile.tabs.calculator': 'Calculadora',
    'profile.tabs.history': 'Histórico',
    'profile.tabs.planner': 'Planejador',
    'profile.tabs.test': 'Test',
    'profile.history.clear': 'Limpar Tudo',
    'profile.history.empty': 'Faça alguns cálculos na página inicial para ver o histórico aqui',
    'profile.history.stats.title': 'Resumo Estatístico',
    'profile.history.stats.calculations': 'Cálculos',
    'profile.history.stats.avgProfit': 'Lucro Médio',
    ...
    'profile.history.removeTitle': 'Remover este cálculo',
    'profile.history.investment': 'Investimento',
    'profile.history.tokens': 'Tokens',
    'profile.history.gems': 'Gemas',
    'profile.history.efficiency': 'Eficiência',

    // Equipment settings
    'equipment.userSettings': 'Configurações do Usuário',
    ...
    'equipment.nicknameDescription': 'Seu nickname será exibido publicamente nos rankings e estatísticas',
    ...
    'analytics.hourlyActivity': 'Atividade por Horário',
    'analytics.mapEfficiency': 'Eficiência por Mapa',
    'analytics.topUsers': 'Top Usuários',
    'analytics.totalRuns': 'Total Runs',
    'analytics.totalTokens': 'Total Tokens',
    'analytics.activeUsers': 'Usuários Ativos',
    'analytics.globalAverage': 'Média Global',
    'analytics.luckRange': 'Faixa de Luck',
    'analytics.runs': 'Runs',
    'analytics.tokens': 'Tokens',
    'analytics.average': 'Média',
    'analytics.users': 'Usuários',
  ...
  en: {
    ...
    'home.wantToAppear': '🚀 Want to appear here too?',
    'home.loginToAppear': 'Login and start using the tools to appear in the community feed!',
    'home.communityComparison': 'Comparison with community statistics',
    
    // Features Section
    'home.features.calculator.title': '🧮 WorldShards Profit Calculator',
    'home.features.calculator.description': 'Calculate your real profit based on gems, tokens and equipment. Analyze investment costs, farmed tokens and return on charges used to maximize your gains.',
    'home.features.calculator.benefit1': 'Precise calculation of gems bought vs. consumed',
    'home.features.calculator.benefit2': 'Analysis of tokens in equipment vs. farmed',
    'home.features.calculator.benefit3': 'Control of charges used and efficiency',
    'home.features.calculator.useButton': 'Use Calculator',
    
    'home.features.planner.title': '🗺️ Map Planner with Luck',
    'home.features.planner.description': 'Plan your map strategies based on your total luck. Analyze different map sizes (small, medium, large, xlarge) and optimize your token drops for maximum efficiency.',
    'home.features.planner.benefit1': 'Analysis of maps by size and luck',
    'home.features.planner.benefit2': 'Control of charges and dropped tokens',
    'home.features.planner.benefit3': 'Efficiency history per map',
    
    'home.features.analytics.title': '📊 Complete Performance Dashboard',
    ...
    'metrics.yesterdayRange': 'Yesterday (05:00 → 05:00)',
