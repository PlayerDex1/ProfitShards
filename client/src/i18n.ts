...
const dicts: Record<Lang, Dict> = {
  pt: {
    ...
    'support.ambassador': 'OpenLoot (Embaixador): use meu link (sem custo)',
    'support.ambassador.cta': 'Abrir na OpenLoot',
  ...
  en: {
    ...
    'support.ambassador': 'OpenLoot (Ambassador): use my link (no extra cost)',
    'support.ambassador.cta': 'Shop on OpenLoot',
